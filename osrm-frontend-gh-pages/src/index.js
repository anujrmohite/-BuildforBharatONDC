...
require('./polyfill');
var drawPolygons = require('./show_polygon');
// console.log(d);
...
// import data from "src/nepal-latest.geojson"
// console.log("thids is data",data);
var district = prompt('Enter district for the polygon (e.g., "North Goa"):');
var subdistrict = prompt('Enter subdistrict for the polygon (e.g., "Satari"):');
var polygonLocation = district + ', ' + subdistrict;
...
drawPolygons(map, district, subdistrict);
